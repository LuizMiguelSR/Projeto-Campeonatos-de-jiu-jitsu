...
@section('conteudo')
        <main class="col h-100 text-light p-4">
            ...
            @endcomponent
            @component('administrativo.layouts._components.alerta_erro')
            @endcomponent
            ...
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    @if (auth()->user()->role === 'Admin')
                        <a href="{{ route('gerenciar_usuarios.novo') }}" class="btn btn-light">+ Cadastrar Usuário</a>
                    @endif
                </div>
            </div>
                            ...
                            @if (auth()->user()->role === 'Admin')
                                <td>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a href="{{ route('gerenciar_usuarios.editar', $usuario->id) }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
                                        ...
                                        <form action="{{ route('gerenciar_usuarios.excluir', $usuario->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
