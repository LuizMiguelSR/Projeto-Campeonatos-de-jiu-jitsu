        ...
        <main class="col h-100 text-light p-4">
            ...
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('gerenciar_usuarios.create') }}" class="btn btn-light">+ Cadastrar Usuário</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a href="{{ route('gerenciar_usuarios.edit', $usuario->id) }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
