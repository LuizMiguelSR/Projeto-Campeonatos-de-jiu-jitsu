...
>
    @guest
        ...
        >
            ...
            >© {{ date('Y') }} <a href="{{ route('inicio') }}" class="hover:underline">OSU BJJ</a>. Todos os
                direitos reservados.
            </span>
            <ul
            ...
            >
                <li>
                <a href="{{ route('inicio') }}" class="mr-4 hover:underline md:mr-6"
                    >Início</a
                >
                </li>
                <li>
                ...
                <li>
                <a href="{{ route('login_atleta') }}" class="mr-4 hover:underline md:mr-6"
