...
@section('conteudo')
    <main class="bg-gray-50">
        ...
        <div class="mt-4 max-w-7xl mx-auto flex justify-between">
            ...
            <a class="flex items-center gap-2 text-blue-700 hover:text-blue-500" href="{{ route('area_atleta.download_pdf', $posicao) }}" target="_blank">
                ...
                <div class="max-w-5xl mx-auto">
                    ...
                    <div class="text-xl">
                        <p class="mt-12">
                            ...
                            <strong class="text-blue-800 whitespace-nowrap">{{ $campeonatos[0]->nome }}</strong>, foi vencedor
                        ...
                        <p class="my-2">
                            Resultado:
                            <strong class="text-blue-800 whitespace-nowrap">{{ $posicao }}º Lugar</strong>
                        </p>
